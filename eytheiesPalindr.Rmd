...
Κατόπιν από αυτόν τον πίνακα κρατήσαμε τις χώρες της Αμερικής, γράφοντας:
...
Έτσι έχουμε τις ευθείες γραμμικής παλινδρόμησης για κάθε χώρα της Νοτίου Αμερικής. Παρατηρούμε την έντονη γραμμική σύνδεση γιατρών-νοσοκόμων σε κάθε χώρα. Ίσως η κοινή ύπαρξη ευθειών ευθείες να αντικατοπτρίζει μια κοινή προσέγγιση στο σύστημα υγείας, η οποία να εξειδικεύεται διαφορετικά σε κάθε περίπτωση, εξ ου και οι διαφορετικές ευθείες.
